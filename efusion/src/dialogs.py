...
class Preferences:
    ...
    def setup_gui( self ):
        ...
        self.noLauncher = self.xml.get_widget( "prefLauncher" )
        self.noLauncher.set_active( self.conf.nolauncher )
...
class AboutDialog(gtk.Window):
    ...
    def __init__(self, gfx,creditText):
        ...
        self.set_title(_("About Yum Extender"))
