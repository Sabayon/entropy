...
class YumexGUI:   
    ...
    def __init__(self):
        ...
        self.grpGroups = YumexGroupsView(self.ui.tvGrpGroups,self.queueView)  
        self.grpCategories = YumexGroupsCategoryView(self.ui.tvGrpCategories)  
    ...
    def setupGUI(self):
        ''' Setup the GUI'''
        self.ui.main.set_title( "Yum Extender %s" % const.__yumex_version__ )        
    ...
    def setupPageButtons(self):
        ...
        self.ui.leftEvent.modify_bg( gtk.STATE_NORMAL, bgcolor )
        # Setup Page Icons
