...
class ToolsTest(unittest.TestCase):
    ...
    def test_read_elf_broken_symbols(self):
        elf_obj = _misc.get_test_so_1()
        known_meta = set(['PyDict_SetItem', 'PyArg_ParseTuple',
        'PyList_New', 'PyList_Append', 'PyFunction_Type',
        'PyExc_AttributeError', 'PyImport_Import', 'PyObject_Init',
        'PyDict_Size', 'PyInt_AsLong', 'PyImport_ImportModule',
        'PyUnicodeUCS4_DecodeASCII', 'PyExc_DeprecationWarning',
        'PyErr_SetObject', 'PyExc_NotImplementedError', 'PyInt_Type',
        'PyErr_Occurred', 'PyClass_Type', 'PyWrapperDescr_Type',
        'PyDict_GetItemString', 'PyLong_FromLong',
        'PyObject_AsCharBuffer', 'Py_AtExit', 'PyLong_FromLongLong',
        'PyErr_Restore', 'PyErr_Print', 'PyObject_CallFunction',
        'PyLong_AsLong', 'PyOS_snprintf', 'PyErr_SetNone',
        'PyLong_AsUnsignedLongMask', 'PyEval_InitThreads',
        'PyProperty_Type', 'PyFloat_AsDouble', 'PyObject_GC_UnTrack',
        'PyWeakref_NewRef', 'PySequence_GetItem', 'PyCObject_Type',
        'PyFloat_FromDouble', 'PySlice_GetIndicesEx',
        'PyExc_SystemError', 'PyErr_NoMemory', 'PyMethod_New',
        'PyErr_SetString', 'PyLong_AsLongLong', 'PyObject_IsInstance',
        'Py_InitModule4_64', 'PyInt_FromSsize_t', 'PyType_Type',
        'PyCallable_Check', '_Py_NoneStruct', 'PyDescr_NewMethod',
        'PyUnicodeUCS4_AsASCIIString', 'PyBool_FromLong',
        'PyObject_CallObject', '_Py_NotImplementedStruct',
        'PyObject_GetBuffer', 'PySlice_Type',
        'PyUnicodeUCS4_DecodeLatin1', 'PyEval_CallObjectWithKeywords',
        'PyCapsule_GetPointer', 'PyExc_BufferError',
        'PyExc_ValueError', 'PyBuffer_Release',
        'PyThread_get_thread_ident', 'PyExc_NameError',
        'Py_FatalError', 'PyGILState_Ensure', 'PyObject_GetAttr',
        'PyDictProxy_New', 'PyExc_RuntimeError',
        'PyUnicodeUCS4_AsWideChar', 'PyInt_FromLong', 'PyTuple_Type',
        'PyBool_Type', 'PyObject_Str', 'PyGILState_Release',
        'PyUnicodeUCS4_FromObject', 'PyModule_GetDict',
        'PyLong_AsVoidPtr', 'PyCObject_AsVoidPtr',
        'PyString_FromString', 'PyObject_Call',
        'PyObject_CheckReadBuffer', 'PyObject_Print',
        'PyDict_GetItem', 'PyType_IsSubtype', 'PyObject_AsReadBuffer',
        'PyCFunction_NewEx', 'PyMem_Free', 'PyDict_SetItemString',
        'PyString_AsString', '_Py_TrueStruct',
        'PyUnicodeUCS4_DecodeUTF8', 'PyNumber_AsSsize_t',
        'PyErr_WarnEx', 'PyLong_FromVoidPtr', 'PyWeakref_GetObject',
        'PyDict_Contains', 'PyUnicodeUCS4_AsUTF8String',
        'PyErr_Fetch', 'PyInt_AsSsize_t', 'PyCapsule_New',
        'PyType_Modified', 'PyErr_Clear', 'PyFloat_Type',
        'PyType_Ready', 'PyExc_Exception', 'PyExc_TypeError',
        'PyObject_Malloc', 'PyImport_GetModuleDict',
        'PyLong_FromUnsignedLong', 'PyType_GenericAlloc',
        'PyTuple_GetSlice', 'PyMethod_Type',
        'PyLong_AsUnsignedLongLongMask', 'PyMem_Malloc',
        'PyUnicodeUCS4_AsLatin1String', 'PyErr_Format',
        'PyExc_IndexError', 'PyBuffer_FillInfo', 'PyTuple_Pack',
        'PyString_FromStringAndSize', 'Py_BuildValue',
        'PyObject_GetAttrString', 'PyTuple_New',
        'PyUnicodeUCS4_FromWideChar', 'PyArg_ParseTupleAndKeywords',
        'PyDict_Next', 'PyLong_FromUnsignedLongLong', 'PyDict_New',
        'PyString_ConcatAndDel', 'PyCFunction_Type', '_Py_ZeroStruct',
        'PyThreadState_Get', 'PyString_FromFormat',
        'PyObject_CallFunctionObjArgs', 'PyCapsule_Type',
        'PyErr_GivenExceptionMatches', 'PyCObject_FromVoidPtr',
        'PyBaseObject_Type', 'PyObject_SetAttr', 'PySequence_Size'])
        metadata = et.read_elf_broken_symbols(elf_obj)
        self.assertEqual(metadata, known_meta)
